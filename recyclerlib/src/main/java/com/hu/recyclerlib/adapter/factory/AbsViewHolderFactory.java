...
public abstract class AbsViewHolderFactory {
     ...
     */
    public final ViewHolder createViewHolder(Context context, ViewGroup parent, int itemType)
            throws ClassNotFoundException, NoSuchMethodException, InstantiationException,
            IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        View view = LayoutInflater.from(context).inflate(getLayoutId(itemType), parent, false);
        return getViewHolder(itemType).getConstructor(View.class)
                .newInstance(view);
    }

    public final ViewHolder createViewHolder(Context context, Class<? extends ViewHolder> viewholderClass, ViewGroup parent, @LayoutRes int layoutId)
